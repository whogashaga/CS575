...
int main(int argc, char *argv[])
{
    ...
    for (int size = 1; size < 1000; size += 10)
    {
        ...
        fprintf(stderr, "ARRAYSIZE, %d,\t", ARRAYSIZE);
        ...
        fprintf(stderr, "NonSimdMul, %.2lf,\t", megaMults);
        ...
        fprintf(stderr, "SimdMul, %.2lf,\t", megaMults);
        double mms = megaMults;
        double speedup = mms / mmn;
        fprintf(stderr, "Speedup, %.2lf,\t", speedup);
        ...
        fprintf(stderr, "NonSimdMulSum, %.2lf,\t", megaMultAdds);
        mmn = megaMultAdds;
        ...
        fprintf(stderr, "SimdMulSum, %.2lf,\t", megaMultAdds);
        mms = megaMultAdds;
        speedup = mms / mmn;
        fprintf(stderr, "Speedup, %.2lf\n", speedup);
